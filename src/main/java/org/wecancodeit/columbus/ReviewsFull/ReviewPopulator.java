...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Review review1 = new Review("Aphex Twin", "./images/aphexTwin.jpg", idm,
				...
				"https://www.youtube.com/embed/S5UBYOv1G9A?controls=1", "./images/aphexMembers.jpg", tagAdven, tagIdm, tagMusic, tagExperimental);
		...
		Review review2 = new Review("Boards of Canada", "./images/boardsOfCanada.jpg", idm,
				...
				"https://www.youtube.com/embed/XaJn3QqiIUc", "./images/boardsMembers.jpg", tagRelax, tagAdven, tagMusic, tagIdm, tagExperimental);
		...
		Review review3 = new Review("Godspeed You! Black Emperor", "./images/godspeedYou!BlackEmporer.jpg", drone,
				...
				"https://www.youtube.com/embed/PZwQeZh6rP0", "./images/godspeedMembers.jpg", tagDrone, tagRelax, tagMusic, tagExperimental);
